                            ...
                            <div class="home_protab1_content">
                                <div class="protab1_top page-top">
                                    <div class="page-title">
                                        <img src="{{asset('images/home1_icon-fa.png')}}" alt="Thời trang">
                                        <h2>Thời trang</h2>
                                    </div>
                                    <ul class="nav nav-tabs">
                                        <li class="active "><a href="#home_protab1_tab_1" data-toggle="tab">Bán chạy</a></li>
                                        <li class=""><a href="#home_protab1_tab_2" data-toggle="tab">Nổi bật</a></li>
                                        <li class=""><a href="#home_protab1_tab_3" data-toggle="tab">Đánh giá nhiều</a></li>
                                        <li class=""><a href="#home_protab1_tab_4" data-toggle="tab">Mới về</a></li>
                                    </ul>
                                </div>
                                <div class="protab1_bottom">
                                    <div class="protab1_banner">
                                        <a href="{{url('/danh-muc-san-pham/'.slugify($category_fashion -> title,'-').'/'.$category_fashion -> id)}}"><img src="{{asset('uploads/categories/'.$category_fashion -> image)}}" alt="{{$category_fashion -> title}}"></a>
                                    </div>
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="home_protab1_tab_1">
                                            <div class="protab1_item">
                                                {{-- san pham ban chay --}}
                                                @forelse($products_fashion_selling as $product)
                                        ...
                                        <div class="tab-pane " id="home_protab1_tab_2">
                                            <div class="protab1_item">
                                                {{-- san pham noi bat --}}
                                                @forelse($products_fashion_featured as $product)
                                                    <!-- kiem tra xem product co giam gia hay khong? -->
                                                    @if(!empty($product -> discount))
                                                    @php $product_price = $product -> price * (100 - $product -> discount)/100; @endphp        
                                                    @else
                                        ...
                                        <div class="tab-pane " id="home_protab1_tab_3">
                                            <div class="protab1_item">
                                                ...
                                                @forelse($products_fashion_reviews as $product)
                                                    <!-- kiem tra xem product co giam gia hay khong? -->
                                                    @if(!empty($product -> discount))
                                                    @php $product_price = $product -> price * (100 - $product -> discount)/100; @endphp        
                                                    @else
                                        ...
                                        <div class="tab-pane " id="home_protab1_tab_4">
                                            <div class="protab1_item">
                                                {{-- san pham moi ve --}}
                                                @forelse($products_fashion_arrivals as $product)
                                                    <!-- kiem tra xem product co giam gia hay khong? -->
                                                    @if(!empty($product -> discount))
                                                    @php $product_price = $product -> price * (100 - $product -> discount)/100; @endphp        
                                                    @else
