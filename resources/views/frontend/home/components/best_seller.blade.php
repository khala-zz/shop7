    ...
    <div class="group-procol">
        <div class="group-inner">
            <div class="page-title">
                <img src="{{asset('images/home1_icon-sale.png')}}" alt="Sản phẩm bán chạy">
                <h2>Sản phẩm bán chạy</h2>
            </div>
            <div class="column_content style_1">
                {{--  get 2 san pham con lai --}}
                <div class="column_item">
                    @forelse($products_selling_2  as $index => $product)
                ...
                {{--  get 3 san pham con lai --}}
                <div class="column_item">
                    <div class="row-container ">
                        @forelse($products_selling_3  as $product)
                            <div class="column_product">
                                <div class="product home_product">
                                    <div class="row-left">
                                        <a href="{{ url('san-pham/'.slugify($product -> title,'-').'/'.$product -> id) }}" class="container_item">
