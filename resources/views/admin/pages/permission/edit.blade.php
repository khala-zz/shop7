...
<section class="content-header">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <h1>
                Sửa phân quyền <strong class="panel-color-id" >#{{ $permission->id }}</strong>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ url('/khalaadmin/') }}"><i class="fa fa-dashboard"></i> Quản lý</a></li>
                <li class="{{ url('/khalaadmin/permissions') }}">Phân quyền</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/khalaadmin/permissions/' . $permission->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        @include ('admin.pages.permission.form', ['formMode' => 'edit'])
