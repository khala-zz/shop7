...
@section('content')
    ...
    <section class="content-header">
        ...
        <h1>
            Sửa sản phẩm <strong class="panel-color-id" >#{{ $product->id }}</strong>
        </h1>
    ...
    <section class="content">
        ...
        <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/khalaadmin/products/' . $product->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('admin.pages.product.form', ['formMode' => 'edit'])
