...
@section('title', ' | Tạo danh mục tin tức')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/khalaadmin/cat_news') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.pages.cat_news.form', ['formMode' => 'create'])
